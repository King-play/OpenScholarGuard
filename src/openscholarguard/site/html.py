  ...
  <div class="shell">
    <nav class="nav">
      ...
      <div class="links">
        ...
        <a href="benchmark/leaderboard.html">ScholarGuardBench</a>
    ...
    <header class="hero">
      <div>
        <div class="eyebrow"><span class="pulse"></span> Public security workflow generated from real scanner output</div>
        ...
        <div class="actions">
          ...
          <a class="button" href="benchmark/leaderboard.html">Open ScholarGuardBench</a>
        ...
        <div class="quick-stats" aria-label="OpenScholarGuard public metrics">
          <div class="stat"><span>Workflow findings</span><strong>{findings}</strong></div>
    ...
    <main>
      <section id="workflow">
        <div class="section-head">
          ...
          <p>The site is generated by the same CLI that ships in the package, so the workflow, benchmark, leaderboard, and gallery are reproducible from the repository.</p>
        </div>
        <div class="grid">
          <a class="card" href="#workflow">
            <div>
              <h3>Security Workflow</h3>
              <p>Walk through suspicious paper intake, findings, sanitizer output, guarded chunks, rule verification, and reproducible attack evidence.</p>
            </div>
            <div class="tagline">
          ...
          <a class="card" href="benchmark/leaderboard.html">
            <div>
              <h3>ScholarGuardBench v0</h3>
              <p>Review the named benchmark with 36 task-style samples, deterministic baseline metrics, model-eval protocol artifacts, and reproducible manifests.</p>
            </div>
            <div class="tagline">
